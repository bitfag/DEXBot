...
class StaggeredConfig(BaseConfig):
    ...
    def configure(cls, return_base_config=True):
        ...
        return BaseConfig.configure(return_base_config) + [
            ...
            ConfigElement(
                'lower_bound', 'float', 1, 'Lower bound', 'The bottom price in the range', (0, 1000000000, 8, '')
            ),
            ConfigElement(
                'upper_bound', 'float', 1000000, 'Upper bound', 'The top price in the range', (0, 1000000000, 8, '')
            ),
            ConfigElement(
